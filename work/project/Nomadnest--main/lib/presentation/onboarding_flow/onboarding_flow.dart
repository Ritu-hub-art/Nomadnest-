        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Logo with specified sizing and clear space
                ...
                builder: (context, value, child) {
                  return Transform.scale(
                    ...
                    child: Opacity(
                      opacity: value,
                      child: Container(
                        // Clear space around logo (at least height of "N")
                        margin: EdgeInsets.symmetric(vertical: 8.h),
                        child: LogoWidget(
                          // ~60% of screen width on 375px devices
                          width: MediaQuery.of(context).size.width * 0.6,
                          height: null, // Let aspect ratio determine height
                        ),
                      ),
                    ),
                  );
                    ...
                    child: Opacity(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.inter(
                          ...
                          color: const Color(0xFF1B365D), // Navy blue from logo
                          letterSpacing: -0.5,
                          height: 1.2,
                        ),
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                const Color(0xFF1B365D), // Navy blue
                            foregroundColor: Colors.white,
                            elevation: 6,
                            shadowColor:
                                const Color(0xFF1B365D).withValues(alpha: 0.3),
