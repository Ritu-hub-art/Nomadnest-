...
class AppTheme {
  ...
  static const Color successLight = Color(0xFF059669); // Safety confirmation green
  static const Color warningLight = Color(0xFFD97706); // Attention-drawing amber
  ...
  static const Color borderLight = Color(0xFFE2E8F0); // Minimal gray for divisions
  ...
  static const Color primaryDark = Color(0xFF2D4A70); // Slightly brighter navy for dark mode
  static const Color secondaryDark = Color(0xFFFF7A47); // Slightly brighter orange for contrast
  static const Color successDark = Color(0xFF10B981); // Brighter green for visibility
  static const Color warningDark = Color(0xFFF59E0B); // Enhanced amber for dark backgrounds
  static const Color errorDark = Color(0xFFEF4444); // Softer red for dark mode
  static const Color surfaceDark = Color(0xFF0F172A); // Deep professional background
  static const Color cardDark = Color(0xFF1E293B); // Elevated card surface
  static const Color borderDark = Color(0xFF334155); // Subtle borders for dark mode
  static const Color textPrimaryDark = Color(0xFFF8FAFC); // High contrast on dark
  static const Color textSecondaryDark = Color(0xFF94A3B8); // Supporting text on dark
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      selectedColor: secondaryLight.withAlpha(26),
      labelStyle: GoogleFonts.inter(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        color: textPrimaryLight,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      selectedColor: secondaryDark.withAlpha(51),
      labelStyle: GoogleFonts.inter(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        color: textPrimaryDark,
